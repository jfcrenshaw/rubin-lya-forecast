...
rule download_bib_file:
    output:
        "src/tex/bib.bib",
    shell:
        'curl -L "https://raw.githubusercontent.com/jfcrenshaw/bibfile/main/My%20Library.bib" -o {output}'
...
rule create_catalogs:
    input:
        "src/data/Euclid_trim_27p10_3p5_IR_4NUV.dat",
    output:
        directory("src/data/observed_catalogs"),
        directory("src/data/training_catalogs"),
    script:
        "src/scripts/create_catalogs.py"

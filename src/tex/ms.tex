...
For the values of $\alpha$ chosen, this is a \input{output/sbar_percent_diff.txt}\unskip\% difference.
...
We use the simulated galaxy catalog of \citet{graham2018, graham2020}, which is based on the Millennium simulation \needscite.
This catalog contains \note{N} galaxies up to redshift \note{N}, with optical LSST photometry and NIR photometry from Euclid and the Roman Space Telescope.
